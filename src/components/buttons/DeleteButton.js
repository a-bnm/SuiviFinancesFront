...
const DeleteButton = ({ handleClick }) => {
    return (
        <button className="w-28 h-10 p-2 m-2 rounded-xl shadow-sm   text-red-800  border-2 border-red-800 flex justify-center space-x-1 btnDelete" onClick={handleClick}  >
            <div className="mt-1">
